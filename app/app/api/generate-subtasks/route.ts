...
export async function POST(request: Request) {
  try {
    ...
    const prompt = `STRICTLY FOLLOW THESE DIRECTIONS LIKE YOUR LIFE DEPENDS ON IT Create a list of ${count} brief but super detailed and concise subtasks for the main task: "${task}" if there are subtasks here STRICTLY DO NOT REPEAT:"${subtaskFlatten}" Ensure each subtask is clear and actionable. Return the subtasks as a JSON array of strings VERY IMPORTANT STRICTLY DO NOT RETURN ASTERISKS IN ANY CASE AND STRICTLY DO NOT NUMBER!!!!`;
